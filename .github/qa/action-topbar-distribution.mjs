...
assert.ok(collection.plugins.some(
  (plugin) => plugin.name === "action-topbar" && plugin.source === "./plugins/action-topbar",
));
...
const packed = spawnSync(
  "npm",
  ["pack", "--dry-run", "--json", "--workspace=bb-plugin-action-topbar"],
