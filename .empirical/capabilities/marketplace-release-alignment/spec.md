# Marketplace Release Alignment Specification

## Purpose

Keep repository-owned plugin releases, default-branch sources, and BB
Community marketplace metadata aligned without changing immutable tags.
