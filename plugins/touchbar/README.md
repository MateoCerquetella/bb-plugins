...
```sh
./plugins/touchbar/native/package.sh 0.1.1
```
...
matching `touchbar/v0.1.1` tag, and attach the unchanged ZIP as
`BBTouchBar-0.1.1-universal.zip`. Publishing the tag/release remains a separate
remote action.
